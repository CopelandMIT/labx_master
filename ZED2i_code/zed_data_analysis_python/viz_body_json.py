...
data_folder = "/home/daniel/labx_master/ZED2i_code/data/squat_v2_45s"
json_file_path = f'{data_folder}/squat_v2_45s_20241211_150242_44s.json'
json_data = load_json_data(json_file_path)
frames = parse_body_data(json_data)
visualize_body_tracking(frames, output_filename=f'{data_folder}/squat_v2.mp4', fps=60)
